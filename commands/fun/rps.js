...
const Discord = require('discord.js');
    ...
    module.exports.run = async(bot, message, args) => {
        ...
        .setDescription(':no_entry_sign: That is a bot. ')
        .setColor('RED')
        .setTitle('Error')
       ...
       let yesornoembed = new Discord.MessageEmbed()
       .setDescription(`${target}, do you want to go against ${message.author} in rps?\nRespond with **y** or **n**`)
       .setColor('GREEN')
       .setTitle('Do you accept?')
       message.channel.send(yesornoembed)
            ...
            if(message.content.toLowerCase() === 'y') {
                const authorChannel = await message.guild.channels.create(`${challenger.username}-rps`.toLowerCase(), {
                    ...
                    const targetChannel = await message.guild.channels.create(`${target.user.username}-rps`.toLowerCase(), {
                        ...
                        let gamestartembed = new Discord.MessageEmbed()
                        .setDescription(`Your channels have been created! Go check it out!\n${message.author}: Go to ${targetChannel}\n${challenger}: Go to ${authorChannel}`)
                        .setColor('GREEN')
                        .setTitle('Let the game start!')
                        message.channel.send(gamestartembed)
    ...
    module.exports.help = {
        name: "rps",
        description: "This command is to play Rock, Paper, Rcissors",
        usage: "-rps <player>",
        accessableby: "Member",
        aliases: [],
    };